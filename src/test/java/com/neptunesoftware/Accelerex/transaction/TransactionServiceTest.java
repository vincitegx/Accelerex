...
class TransactionServiceTest {
    ...
    void can_confirm_transaction_type_is_Credit(){
        //given
        User user = new User(1, "test Name 1", "test1@mail.com", userService.encodePassword("12345"), true);
        Transaction transaction = new Transaction(user,"878676790", "765362789", new BigDecimal("500"), "testRefNum", "testTransaction", new BigDecimal("500"), "testSender", "testReceiver", "testReceiver", TransactionStatus.SUCCESS, TransactionType.CREDIT);
