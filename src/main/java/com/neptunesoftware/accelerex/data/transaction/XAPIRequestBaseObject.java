...
@XmlSeeAlso({
    TxnProcessBatchRequestData.class,
    TxnProcessBatchItemRequestData.class,
    ServiceVouchersEnquiryRequestData.class,
    ClearingChequeResponseData.class,
    TxnChargeRequestData.class,
    XAPIBaseTxnRequestData.class,
    TxnDocumentRequestData.class,
    WFViewRequestData.class,
    GLTransferRequest.class,
    DrawerRequestData.class
})
