...
@XmlSeeAlso({
    AccountRelationshipRequestData.class,
    ApplicationImageRequestData.class,
    AccountReviewRequestData.class,
    ApplicationAddressRequestData.class,
    ApplicationContactInfoRequestData.class,
    ApplicationDocumentRequestData.class,
    ApplicationEmploymentRequestData.class,
    ApplicationIdentificationRequestData.class,
    ApplicationSavingsPlanRequestData.class,
    ChequeBookRequest.class,
    AccountRequest.class,
    CustomInfomationRequestData.class,
    DepositAccountRequestData.class,
    DepositAccountSavingsPlanRequestData.class,
    FundReservationRequest.class,
    ChequeStopRequest.class,
    TermAccountLiquidationRequestData.class,
    TermAccountRequestData.class,
    TermDepositRolloverInputData.class,
    AccountBalanceRequest.class,
    AccountBlockEnquiryRequest.class,
    AccountRiskRequest.class,
    ChequeStatusRequest.class,
    ClearingChequeEnquiryRequest.class,
    CustomInformationRequestData.class,
    StatementRequest.class,
    GLAccountInfoRequestData.class,
    DepositScheduleRequestData.class,
    ChequeDetailsRequest.class,
    LoanAccountEventRequest.class,
    BiometricVerificationRequestData.class,
    WFViewRequestData.class,
    GroupMemberRequestData.class,
    CustomerNextKinRequestData.class,
    CustomerRequest.class,
    CustomerAmlInfoData.class,
    CustomerDocumentInformation.class,
    CustomerEmploymentData.class,
    CustomerRelationshipInformation.class,
    CreditFacilityApplnRequestData.class,
    TransactionInquiryRequest.class
})
