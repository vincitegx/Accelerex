...
import com.neptunesoftware.accelerex.data.customer.CustomerOutputData;
    ...
    public CreateAccountResponse creatNewCustomer(CreateAccountRequest request) {
        ...
        try {
            ...
            try {
                ...
                customerRequest.setCustShortName(request.getFirstName());
                ...
                customerRequest.setChannelCode("MBANK");
...
//                    imageData = (ApplicationImageRequestData) getCommonRequest(imageData);
                    ...
                    depositAccountAppl.setChannelCode("MBANK");
                    ...
                    addressData.setChannelCode("MBANK");
                    ...
                    contactData.setChannelCode("MBANK");
                    ...
                    contactData1.setChannelCode("MBANK");
                    ...
                    DepositAcctApplicationOutputData depositresponse = (DepositAcctApplicationOutputData) webServiceTemplate
                    ...
                    if (!(depositresponse.getAcctNumber().equals(null))) {
