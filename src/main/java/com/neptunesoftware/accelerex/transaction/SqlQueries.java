...
public class SqlQueries {
    static final String TRANSACTION_HISTORY_QUERY = """
            SELECT REC_TS, FROM_ACCT_NO, TRAN_REF, TRAN_AMT FROM ALT_AGENCY_MB WHERE (FROM_ACCT_NO = ? OR TO_ACCT_NO = ?) AND REC_TS BETWEEN TO_TIMESTAMP(?,'YYYY-MM-DD HH24:MI:SS.FF6') AND TO_TIMESTAMP(?,'YYYY-MM-DD HH24:MI:SS.FF6')
            """;
